...
export const fetchCustomerOrdersSuccess = createAction('[App] Fetch Customer Orders Success', props<{payload: { customerOrders: ICustomerOrder[] }}>());
export const fetchCustomerOrdersFailure = createAction('[App] Fetch Customer Orders Failure', props<{payload: { error: Error }}>());